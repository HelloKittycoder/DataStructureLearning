...
public class Tester {
    ...
    public static Collection<Object[]> testcases() {
        return Arrays.asList(new Object[][]{
            ...
            {"()[]{}", true},     // test case 2 (init parameters below: {para1, para2, expected})
            {"(]", false},      // test case 3 (init parameters below: {para1, para2, expected})
            {"([)]", false},
            {"{[]}", true}
        });
    }
    ...
    public void test() {
        //
        boolean actual = solution.isValid(para1);
        //
