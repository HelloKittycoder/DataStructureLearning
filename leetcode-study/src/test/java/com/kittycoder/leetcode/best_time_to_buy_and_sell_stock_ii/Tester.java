...
public class Tester {
    ...
    public static Collection<Object[]> testcases() {
        ...
        return Arrays.asList(new Object[][]{
            {new int[]{7, 1, 5, 3, 6, 4}, 7},     // test case 1 (init parameters below: {para1, para2, expected})
            {new int[]{1, 2, 3, 4, 5}, 4},     // test case 2 (init parameters below: {para1, para2, expected})
            {new int[]{5, 4, 3, 2, 1}, 0},      // test case 3 (init parameters below: {para1, para2, expected})
            {largeArray, 7546656}
        });
    }
